...
from prismatic_vlms.prismatic.models.vlms import PrismaticVLM
from train.vlm_train.overwatch import initialize_overwatch
from train.vlm_train.strategies.base_strategy import TrainingStrategy
...
class FSDPStrategy(TrainingStrategy):
    ...
    def save_checkpoint(
        ...
        assert isinstance(
            self.vlm, FSDP), "FSDPStrategy.save_checkpoint assumes VLM is already wrapped in FSDP!"
        ...
        with FSDP.state_dict_type(self.vlm, self.fsdp_state_dict_type, self.fsdp_save_policy):
            ...
            if overwatch.is_rank_zero():
                ...
                shutil.copy(checkpoint_path, checkpoint_dir /
    ...
    def run_setup(self, run_dir: Path, n_train_examples: int) -> None:
        ...
        if self.enable_mixed_precision_training and self.mixed_precision_dtype == torch.bfloat16:
            ...
            # for name, param in self.vlm.vision_backbone.named_parameters():
        ...
        # vlm_policy = self.vlm.get_fsdp_wrapping_policy()
        # print(vlm_policy)
        # for name, module in self.vlm.vision_backbone.named_modules():
        ...
        self.vlm = FSDP(
            ...
            # ignored_modules=[self.vlm.vision_backbone.text_featurizer]
        )
        ...
        if self.lr_scheduler_type == "linear-warmup+cosine-decay":
            ...
            groups = [{"params": decay, "weight_decay": self.weight_decay}, {
